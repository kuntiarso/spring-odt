...
public class VaEventProducer {
    ...
    private final KafkaTopicConfigProperties kafkaTopicConfig;
    ...
    public void publishVaPaymentCreated(String transactionId, VaResponseDto vaPaymentCreatedEvent) {
        ...
        kafkaTemplate.send(kafkaTopicConfig.getProducer().getVaPaymentCreated(), transactionId, vaPaymentCreatedEvent);
    }
}